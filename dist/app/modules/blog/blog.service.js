...
//   update blog
const updateOneInDB = (id, data, user) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      userId !==
        (review === null || review === void 0 ? void 0 : review.userId) ||
...
//   delete feedback
const deleteByIdFromDB = (id, user) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id: userId, role } = user;
    ...
    if (
      (deletedBlog === null || deletedBlog === void 0
        ? void 0
        : deletedBlog.userId) !== userId ||
      role !== user_1.ENUM_USER_ROLE.SUPER_ADMIN
    ) {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
